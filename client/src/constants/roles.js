export const ROLES = {
  EMPLOYEE: {
    ...
    handwrittenNote: 'Attendance and payslips made simple',
    accentColor: '#10B981',
    badgeStyles: {
      bg: 'bg-emerald-50',
  ...
  HR_MANAGER: {
    ...
    handwrittenNote: 'People operations in total sync',
    accentColor: '#2563EB',
    badgeStyles: {
      bg: 'bg-blue-50',
      text: 'text-blue-700',
  ...
  HR_PAYROLL_USER: {
    ...
    handwrittenNote: 'Precision in every payroll calculation',
    accentColor: '#D97706',
    badgeStyles: {
      bg: 'bg-amber-50',
      text: 'text-amber-800',
  ...
  HR_PAYROLL_MANAGER: {
    ...
    handwrittenNote: 'Compliant and authorized disbursals',
    accentColor: '#714B67',
    badgeStyles: {
      bg: 'bg-purple-50',
      text: 'text-[#714B67]',
  ...
  ADMIN: {
    ...
    handwrittenNote: 'Total platform security and governance',
    accentColor: '#E11D48',
    badgeStyles: {
      bg: 'bg-rose-50',
      text: 'text-rose-700',
